        ...
        <table id="dataTable" class="table table-striped  table-bordered" style="width: 100%;">
            <thead>
                ...
                <tr>
                    ...
                    <th scope="col">SL</th>
                    <th scope="col">Reffer</th>
                    <th scope="col"> Bonous</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open(['route' => 'sponsor.store', 'class' => 'form', 'id' => 'ccccc']) !!}

                     {!! Form::hidden('refferid', '', ['id' => 'id']) !!}
                
                    {!! Form::label('reffer', ' Reffer *') !!}
                    {!! Form::text('reffer', null, ['id' => 'reffer', 'class' => 'form-control', 'placeholder' => 'Add Reffer']) !!}


                    {!! Form::label('bonus', ' Bonus ') !!}
                    {!! Form::number('bonus', null, ['id' => 'bonus', 'class' => 'form-control', 'placeholder' => 'Add bonus']) !!}
            ...
            $(document).ready(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(d) {
                                if (d.success) {
                                    ...
                                    $('#dataTable').DataTable().ajax.reload();
                                     clearform();
                                     toastr.success('New Sponsor Add Successfully');
                                } else {
                ...
                $("#exampleModalCenter").on('click', '#addBtn', function() {
                    if ($(this).val() == 'Update') {
                        ...
                        $.ajax({
                            url: url + '/admin/sponsor/' + $("#matchingid").val(),
                            method: "PUT",
                            type: "PUT",
                            data: {
                                reffer: $("#reffer").val(),
                ...
                $("#dataTable").on('click', '#editBtn', function() {
                    $refferid = $(this).attr('rid');

                    $info_url = url + '/admin/sponsor/' + $refferid + '/edit';
                ...
                function populateForm(data) {
                    $("#reffer").val(data.reffer);
                    $("#bonus").val(data.bonus);
                     $("#refferid").val(data.id);
                    $("#addBtn").val('Update');
                }
                function clearform() {
                    $('#ccccc')[0].reset();
                    $("#addBtn").val('Save Sponsor');
                }
