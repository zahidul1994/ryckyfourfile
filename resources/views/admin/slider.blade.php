...
<table class="table" border="1">
    ...
    <tr>
        ...
        <td>
               <a href="{{ url('admin/slider/sedit',$p->id) }}" class="btn btn-sm btn-primary">Edit</a>
            <a onclick="return confirm('Are you sure you want to delete this Slider ?');" href="{{url('admin/slider/delete/'.$p->id)}}" class="btn btn-sm btn-danger">Delete</a>
        </td>
    </tr>
    @endforeach
</table>
